    ...
    return <React.Fragment>
      <header className="intro">
        <div className="intro-text">
          ...
          <HashLink smooth className="btn btn-outline-primary btn-xl text-uppercase text-white" to="/#about">Tell Me
            More</HashLink>
      ...
      <section id="about" className="container">
        <div className="row justify-content-center">
          ...
          <div className="col-md-8">
            ...
            <p>
              Also, you can visit <Link to="/features">Features</Link> to see full features list or
              watch <HashLink smooth className="link" to="/#video">demo video</HashLink>. If you want to
      ...
      <section id="video" className="container">
        <div className="row justify-content-center">
          <div className="col text-center">
            ...
            <h3 className="section-subheading text-muted mb-4">This is a quick demo video.</h3>
            <iframe className="mw-100" width="600" height="300" title="demo video"
